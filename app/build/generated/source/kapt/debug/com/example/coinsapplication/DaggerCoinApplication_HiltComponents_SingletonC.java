...
import com.example.coinsapplication.di.AppModule_ProvideCoinApiFactory;
import com.example.coinsapplication.di.AppModule_ProvideCoinRepositoryFactory;
...
import com.example.coinsapplication.prisentation.MainActivity;
import com.example.coinsapplication.prisentation.TwitterScreen.CoinTwitterViewModel;
import com.example.coinsapplication.prisentation.TwitterScreen.CoinTwitterViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.coinsapplication.prisentation.coinDetailsScreen.CoinDetailsViewModel;
import com.example.coinsapplication.prisentation.coinDetailsScreen.CoinDetailsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.coinsapplication.prisentation.coinsScreen.CoinsViewModel;
import com.example.coinsapplication.prisentation.coinsScreen.CoinsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerCoinApplication_HiltComponents_SingletonC extends CoinApplication_HiltComponents.SingletonC {
  ...
  private CoinRepository coinRepository() {
    return AppModule_ProvideCoinRepositoryFactory.provideCoinRepository(provideCoinApiProvider.get());
  }

  @SuppressWarnings("unchecked")
  private void initialize(final ApplicationContextModule applicationContextModuleParam) {
    this.provideCoinApiProvider = DoubleCheck.provider(new SwitchingProvider<CoinApi>(singletonC, 1));
    this.provideCoinRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<CoinRepository>(singletonC, 0));
  }

  @Override
  public void injectCoinApplication(CoinApplication coinApplication) {
  }
  ...
  private static final class ActivityCImpl extends CoinApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(3).add(CoinDetailsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(CoinTwitterViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(CoinsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends CoinApplication_HiltComponents.ViewModelC {
    ...
    private Provider<CoinTwitterViewModel> coinTwitterViewModelProvider;
    ...
    private CoinDetailsUseCase coinDetailsUseCase() {
      return new CoinDetailsUseCase(singletonC.provideCoinRepositoryProvider.get());
    }
    ...
    private GetTwitterUseCase getTwitterUseCase() {
      return new GetTwitterUseCase(singletonC.provideCoinRepositoryProvider.get());
    }

    private CoinTwitterViewModel coinTwitterViewModel() {
      return new CoinTwitterViewModel(getTwitterUseCase(), savedStateHandle);
    }

    private CoinsUseCase coinsUseCase() {
      return new CoinsUseCase(singletonC.provideCoinRepositoryProvider.get());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam) {
      ...
      this.coinTwitterViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 1);
      this.coinsViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 2);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.example.coinsapplication.prisentation.coinDetailsScreen.CoinDetailsViewModel", (Provider) coinDetailsViewModelProvider).put("com.example.coinsapplication.prisentation.TwitterScreen.CoinTwitterViewModel", (Provider) coinTwitterViewModelProvider).put("com.example.coinsapplication.prisentation.coinsScreen.CoinsViewModel", (Provider) coinsViewModelProvider).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.coinsapplication.prisentation.coinDetailsScreen.CoinDetailsViewModel 
          return (T) viewModelCImpl.coinDetailsViewModel();

          case 1: // com.example.coinsapplication.prisentation.TwitterScreen.CoinTwitterViewModel 
          return (T) viewModelCImpl.coinTwitterViewModel();

          case 2: // com.example.coinsapplication.prisentation.coinsScreen.CoinsViewModel 
          return (T) viewModelCImpl.coinsViewModel();
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // com.example.coinsapplication.domain.repository.CoinRepository 
        return (T) singletonC.coinRepository();

        case 1: // com.example.coinsapplication.data.CoinApi 
        return (T) AppModule_ProvideCoinApiFactory.provideCoinApi();
